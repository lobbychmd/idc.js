...
var metaTreeConfig = {
    ...
    "SrvGroup": {
        ...
        children: [{ "type": "QuerySrvGroup", "caption": "数据接口", "query": "" },
                   { "type": "BizSrvGroup", "caption": "业务接口", "query": "" },
                   { "type": "SrvQueueGroup", "caption": "总线调度队列", "query": "" }]
    },
    "QuerySrvGroup": {
        text: "caption",
        children: [{ type: "Srv", "query": {ProjectName: "@ProjectName", SrvType: 'Query'}}]
    },
    "BizSrvGroup": {
        text: "caption",
        children: [{ type: "Srv", "query": {ProjectName: "@ProjectName", SrvType: 'Biz'}}]
    },
    "SrvQueueGroup": {
        text: "caption",
...
exports.metaTreeTypes = ["Theme","MetaProject", "MetaModule", "MetaQuery", "MetaBiz", "MetaField", "MetaFunction", "Menu", "Srv", "SrvQueue"];
