...
mongoose.model("MetaTheme", new Schema({
    Theme: String, LayoutUI: String, ProjectName: String,Version: String, HashCode: String
}), "MetaTheme");

mongoose.model("MetaQuerySrv", new Schema({
    Name: String, Summary: String, QueryName: String, 
    ProjectName: String, SrvCode: String, SrvType: String,
...
mongoose.model("MetaSrvQueue", new Schema({
    Name: String, Interval: Number, IntervalUnit: String,  SrvCode: String,
    Items:[{QueueIndex: Number, SourceSrv: String, DestinationSrv: String}],
    Version: String, HashCode: String
}), "MetaSrvQueue");

mongoose.model("MetaDataPublishSrv", new Schema({
    Name: String, IdField: String, SrvCode: String, QueryName : String,
    Version: String, HashCode: String
}), "MetaDataPublishSrv");

mongoose.model("MetaExternalSrv", new Schema({
    Name: String, SrvParams: String, SrvCode: String, SrvType : String,URI : String,
    Version: String, HashCode: String
}), "MetaExternalSrv");
