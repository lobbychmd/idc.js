...
var dburl = 'mongodb://MIS:MISSOLUTION@180.153.177.140/idc';
//var dburl = 'mongodb://localhost/idc';
...
mongoose.model("MetaConnection", new Schema({
    ProjectName: String, Alias: String, Summary: String, ConnectionString: String
}), "MetaConnection");
...
mongoose.model("Project", new Schema({
    ...
    ProjectCode: String, SyncPassword: String, SimulateCode: String,
    Users: [{ type: Schema.ObjectId, ref: 'Account' }]
}), "Project");

require("schema").metaMongoose();
...
mongoose.model("MetaTable", new Schema({
    TableName: String,
    ProjectName: String,Version: String, HashCode: String,
    Columns: [{Size: Number, Precision: Number, Scale: Number, AllowNull: Boolean, IsIdentity: Boolean, Type: Number }],
    Indexes: [{PrimaryKey: Boolean, IsUnique: Boolean}]
}), "MetaTable");
...
mongoose.model('InviteCode', new Schema({
    Code: String, AccountID: Schema.ObjectId, UseTime: Date
