...
mongoose.model("MetaSrv", new Schema({
    Name: String, Summary: String, QueryName: String, BizID: String, 
...
mongoose.model("MetaSrvQueue", new Schema({
    Name: String, Interval: Number, SrvType: String, SrvDataType: String, SrvAddress: String,
    Items:[{QueueIndex: Number, SrvCode: String}],
    Version: String, HashCode: String
}), "MetaSrvQueue");


mongoose.model("MetaDataPublish", new Schema({
    Name: String, IdField: String, QuerySrvCode: String,
    Version: String, HashCode: String
}), "MetaDataPublish");
