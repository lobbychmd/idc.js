...
exports.add_version = function (type, _id, callback) {
    ...
    m.findOne({ _id: _id }, function (err, doc) {
        ...
        mv.where("MetaType", type).where("ModelId", _id).desc('Version').run(function (err1, verdocs) {
            ...
            new mv({ MetaType: type, ModelId: _id, Version: newver, Script: script, HashCode: js_utils.hashcode(script), At: new Date() }).save(function (err, rows) {
                m.update({_id: _id}, {Version: newver.toString()}, function(){
